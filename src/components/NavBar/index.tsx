  ...
  return (
    <div className="border-b border-solid border-gray-300 bg-white">
      <div className="flex h-70 items-center justify-between p-20 lg:mx-auto lg:max-w-[1200px]">
        <Link href="/">
          <Image width={172} height={30} src="/svgs/navbar-logo.svg" alt="네비바 로고" priority />
        </Link>
        {accessToken ? (
          <div className="flex items-center">
            <Image src="svgs/icon-bell.svg" alt="네비바 알림 벨" width={20} height={20} />
            <div className="mx-12 h-22 border-l border-solid border-gray-300 md:mx-25" />
            <div className="relative flex items-center gap-10">
              <Image src="svgs/icon-test-profile.svg" alt="프로필 이미지" width={32} height={32} />
